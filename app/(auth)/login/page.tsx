        ...
        <div className="min-h-screen grid lg:grid-cols-2 bg-slate-950">
            <div className="hidden lg:flex flex-col justify-center p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 text-slate-200">
                    ...
                    <p className="text-lg text-slate-400">Secure access to your cybersecurity dashboard.</p>
                </div>
            </div>
                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-slate-400">
                            Don't have an account? <Link href="/register" className="font-medium text-sky-500 hover:text-sky-400">Register now</Link>
                        </p>
                    </div>
